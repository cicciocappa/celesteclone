/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sat Feb 15 15:08:37 2025.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.3" --generator="c" --spec="gl" --no-loader --local-files --extensions=""
    Online:
